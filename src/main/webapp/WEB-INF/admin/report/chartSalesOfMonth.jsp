    ...
    window.onload = function () {
        ...
        var chart = new CanvasJS.Chart("chartContainer", {
            ...
            axisX: {
                ...
                interval: 1,
                gridColor: "orange",
                title: "<spring:message code="chart.day" />"
            },
            axisY: {
...
<div class="container">
    ...
    <div class="row my-2">  
        ...
        <div class="col-md-11">
            <form action="">
                <div class="row">
                    <div class="col-md-4">
                        <input class="form-control" type="number" min="0" value="${month}" name="month" placeholder="Nhập tháng" required/>
                    </div>
                    <div class="col-md-4">
    ...
    <h3><spring:message code="chart.dayHaveSalesMin" /> ${statistic.get("minDay")} : <fmt:formatNumber type="number" maxFractionDigits="2" value="${statistic.get('min')}"/> <spring:message code="chart.vnd" /></h3>      

    <h3><spring:message code="chart.dayHaveSalesMax" /> ${statistic.get("maxDay")} : <fmt:formatNumber type="number" maxFractionDigits="2" value="${statistic.get('max')}"/> <spring:message code="chart.vnd" /></h3>       
