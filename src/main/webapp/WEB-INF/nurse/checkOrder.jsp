                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><fmt:formatNumber type="number" maxFractionDigits="2" value="${data.get('expense')}"/></td>
                                </tr>
                                <tr>
                                    <td><spring:message code="label.prescription" /></td>
                                    <td><fmt:formatNumber type="number" maxFractionDigits="2" value="${data.get('totalPrice')}"/></td>
                                </tr>
                                <tr>
                                    <td><spring:message code="label.total" /></td>
                                    <td><fmt:formatNumber type="number" maxFractionDigits="2" value="${data.get('total')}"/></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
